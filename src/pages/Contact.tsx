...
const Contact = () => {
  ...
  return (
    <>
      <MetaTags
        title="Contact Us - FindMyHorse"
        description="Get in touch with the FindMyHorse team. Contact us for help with your UK equestrian legal questions."
      />
        ...
        <section className="hero-gradient text-equine-cream py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-equine-sage-light leading-relaxed">
              Ready to discuss your equestrian legal needs? We're here to help with expert guidance and personalised solutions for your situation.
            </p>
          </div>
        </section>
